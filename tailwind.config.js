  ...
  theme: {
    extend: {
      colors: {
        ...
        // Secondary Colors - Professional supporting content
        secondary: {
        ...
        // Accent Colors - Strategic attention and warmth
        accent: {
        ...
        // Text Colors
        text: {
          primary: "#1E293B", // slate-800 - Optimal reading contrast
          secondary: "#64748B", // slate-500 - Clear information hierarchy
        },
        // Status Colors
        success: "#10B981", // emerald-500 - Positive confirmation moments
        warning: "#F59E0B", // amber-500 - Important but not alarming
        error: "#EF4444", // red-500 - Clear helpful guidance
        // Border Colors
        border: {
